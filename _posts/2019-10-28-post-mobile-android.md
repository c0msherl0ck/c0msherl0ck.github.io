...
안드로이드 운영체제를 사용하는 핸드폰의 경우, adb(Android Debug Bridge)를 통해 핸드폰에 dd 명령어를 입력함으로써 이미지를 획득한다. 이번 글에서는 Rooting, BusyBox 설치 등 이미징 사전 준비단계부터 이미지 획득까지 전 과정에 대해 서술한다.
...
<center><p>
<img src="/assets/~/adb_folder.jpg" width="100%">
<em>adb 폴더</em>
</p></center>
...
<center><p>
<img src="/assets/~/adb_devices.jpg" width="100%">
...
<center><p>
<img src="/assets/~/autoroot.jpg" width="100%">
<em>autoroot 사이트</em>
</p></center>
...
<center><p>
<img src="/assets/~/download_files.jpg" width="100%">
<em>다운로드 파일</em>
</p></center>

`odin`을 실행하고, `AP` 버튼을 클릭하여 다운로드 받은 파일 중 다음의 파일을 선택한다.

<center><p>
<img src="/assets/~/odin.jpg" width="100%">
<em>odin software</em>
</p></center>

`start`를 누르기 이전에 핸드폰을 **다운로드 모드**로 부팅한다.(부팅 시 `볼륨 버튼 하 버튼 + 홈 버튼 + 전원 버튼` 동시 누름)

<center><p>
<img src="/assets/~/download_mode.jpg" width="100%">
<em>다운로드 모드 화면</em>
</p></center>

`start`를 누른다.

완료 시 다음과 같이 `SuperUser 파일`이 생성된 것을 확인할 수 있다.

<center><p>
<img src="/assets/~/SuperUser.jpg" width="100%">
<em>SuperUser 파일</em>
</p></center>
...
<center><p>
<img src="/assets/~/root_permission.jpg" width="100%">
...
<center><p>
<img src="/assets/~/su.jpg" width="100%">
...
<center><p>
<img src="/assets/~/buxybox_1.jpg" width="100%"><br>
<img src="/assets/~/buxybox_2.jpg" width="100%"><br>
<em>BusyBox 설치 확인</em>
</p></center>
...
상기의 사이트에서 netcat을 다운로드 받고, `windows/system32/` 경로에 복사 붙여넣기 한다. 해당 경로는 cmd 창에서 사용할 수 있는 윈도우 기본 명령어들이 존재하는 곳이다.

> 안드로이드폰 이미지 획득하기

cmd 창을 2개 띄운다. 하나는 컴퓨터에 명령어를 입력하기 위함이고, 다른 하나는 adb 를 통해 핸드폰에 명령어를 입력하기 위함이다.

<추가><추가><추가><추가><추가><추가><추가><추가><추가>
